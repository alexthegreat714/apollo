...
class Config:
    ...
    # Model Configuration - Apollo-specific env vars
    # Generation model (for answering questions): APOLLO_GENERATION_MODEL
    # Embedding model (for RAG): APOLLO_EMBEDDING_MODEL
    GENERATION_MODEL: str = os.getenv("APOLLO_GENERATION_MODEL", "Fino1-8B.Q6_K")
    EMBEDDING_MODEL: str = os.getenv("APOLLO_EMBEDDING_MODEL", "nomic-embed-text")
